...
Nexus is more than an interface; it is an argument for a more inclusive, empathetic approach to Web3 design.

\section{FUTURE WORK}
\begin{itemize}
    \item \textbf{Voice Integration}: Allowing hands-free operation for accessibility.
...
\textbf{Confirmation}: When the network has officially recorded your transaction. It is irreversible after this.
...
We thank the open-source community, specifically the developers of Ethers.js, Next.js, and the Google Gemini team, for providing the robust tools that make this "friendly" future possible.
